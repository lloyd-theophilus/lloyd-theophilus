...
Kubernetes AWS Ubuntu Apple Silicon Jenkins Grafana Prometheus Docker Vim  nano VScode Postgres Database Loki 
...
I WANT TO BE THE BEST DEVOPS ENGINEER!!!
🏃🏿 Personal Interests
...
Technical writing
I have written over 20 technical articles for several articles on hashnode
...
Below are some of my plans for the next few months as related to the CNCF (Cloud Native Computing Foundation). Will check off the items and drop notes as I achieve each.
 ...
 Write at least 5 Technical tutorials on cloud native on devopsmentorship.
