...
[![Linkedin Badge](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white&link=https://www.linkedin.com/in/lloyd-osabutey-anikon)](https://www.linkedin.com/in/lloyd-osabutey-anikon) [![Twitter Badge](https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white)](https://x.com/lloydtheophilus)


# 🫃🏿 My Work as a Cloud DevOps Engineer
## Technical writing
I have written over 15 technical articles in the past 2 years and contributed to open source project. Below are some highlights:

1. [My Honest Opinion About AWS DevOps Agent: A Deep, Practical, and Unfiltered Review](https://lloyd82.hashnode.dev/my-honest-opinion-about-aws-devops-agent-a-deep-practical-and-unfiltered-review)
2. [5 Common Terraform Mistakes and How to Avoid Them](https://lloyd82.hashnode.dev/5-common-terraform-mistakes-and-how-to-avoid-them)
3. [Run Kubernetes Clusters for Less with Amazon EC2 Spot and Karpenter](https://lloyd82.hashnode.dev/run-kubernetes-clusters-for-less-with-amazon-ec2-spot-and-karpenter)
4. [Why African Startups Should Embrace Serverless Architecture Now, Not Later](https://lloyd82.hashnode.dev/why-african-startups-should-embrace-serverless-architecture-now-not-later)
5. [Migrating an Amazon RDS DB Instance to Another VPC in a Different AWS Account](https://lloyd82.hashnode.dev/migrating-an-amazon-rds-db-instance-to-another-vpc-in-a-different-aws-account)
6. [Migrating an Amazon RDS DB Instance to Another VPC in the Same AWS Account](https://lloyd82.hashnode.dev/migrating-an-amazon-rds-db-instance-to-another-vpc-in-the-same-aws-account)
7. [How to Securely Display Objects from an S3 Bucket in a Browser4](https://lloyd82.hashnode.dev/how-to-securely-display-objects-from-an-s3-bucket-in-a-browser4)


## Community 
I am active in the Cloud Native and DevOps community as:

- AWS Community Builder for the Security Category
- DevOps Dojo
- Roadmap.sh 
- Devops Projects
- EKS Goat 
